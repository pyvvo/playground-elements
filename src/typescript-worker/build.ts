...
export const build = async (
  ...
  const tsBuilder = new TypeScriptBuilder(moduleResolver, cdn);
  const bareModuleBuilder = new BareModuleTransformer(moduleResolver, cdn);
